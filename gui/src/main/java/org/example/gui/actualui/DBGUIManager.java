package org.example.gui.actualui;


import org.example.gui.database.Database;
import org.example.gui.database.DatabaseReader;
import org.example.gui.database.Element;
import org.example.gui.database.Result;
import org.example.gui.database.Row;
...
class DBGUIManager extends JFrame {
    ...
    private JMenuBar initializeMenuBar() {
        ...
        JMenuItem menuCombine = new JMenuItem("Різниця таблиць");
        ...
        menuCombine.addActionListener(e -> {
            ...
            displayQueryResults(database.query(String.format("SUBTRACT %s from %s", tableNames.get(0), tableNames.get(1))), false);
        });
        ...
        menuAbout.addActionListener(e -> JOptionPane.showMessageDialog(this, "DBMS Barysh Artem TTP-42"));
    ...
    private JPanel initializeControlPanel() {
        ...
        clearButton.addActionListener(e -> queryTextField.setText(""));
